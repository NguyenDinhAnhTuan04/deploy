"""
Data Seeder for Testing Workflow
Generates mock data when seed_data.enabled = true in workflow.yaml
Allows testing workflow without real accidents, patterns, or camera updates
"""
