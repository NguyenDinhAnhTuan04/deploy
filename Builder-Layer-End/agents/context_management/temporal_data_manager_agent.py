"""
Temporal Data Manager Agent - Domain-Agnostic Temporal Data Lifecycle Manager

This agent manages the complete lifecycle of temporal observations:
...
Architecture:
- Domain-agnostic: Works with any temporal entity and attributes
- Config-driven: All policies, schedules, and storage in YAML
- Production-ready: Cron scheduling, batching, error handling, monitoring
