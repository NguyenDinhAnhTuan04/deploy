...
100% DOMAIN-AGNOSTIC - Query ANY entity type from Stellio with filters
100% CONFIG-DRIVEN - All endpoints and filters in config/stellio.yaml

This agent queries Stellio Context Broker to retrieve updated entities
(e.g., Camera entities with congested=true) after state changes.

Used in Phase 8 (State Update Sync) to sync entity state updates to RDF/Fuseki.
