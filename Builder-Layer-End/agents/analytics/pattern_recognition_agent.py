...
CONFIG-DRIVEN: All parameters, thresholds, and analysis methods in YAML.
...
- TrafficPattern entity creation (NGSI-LD)
- Camera prediction updates

Architecture:
- PatternConfig: Load/validate YAML configuration
- Neo4jConnector: Query temporal data from Neo4j graph
- TimeSeriesAnalyzer: Statistical analysis of time-series data
- PatternDetector: Detect rush hours, weekly patterns, anomalies
- ForecastEngine: Generate predictions (moving average, ARIMA)
- PatternRecognitionAgent: Orchestrate analysis pipeline
