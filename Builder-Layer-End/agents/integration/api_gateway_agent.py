"""
API Gateway Agent - Domain-Agnostic HTTP Gateway with Authentication, Rate Limiting, and Caching

This module implements a production-ready API gateway that provides:
- Multiple authentication methods (API key, JWT)
- Token bucket rate limiting with Redis storage
