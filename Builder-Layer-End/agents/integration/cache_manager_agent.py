"""
Cache Manager Agent - Domain-Agnostic Caching Layer

This module provides a production-ready Redis-based caching layer with:
- Cache key generation from URL + params + headers
...
100% domain-agnostic - works with any backend service via configuration.
"""
