...
This agent transforms raw data into NGSI-LD format following ETSI specifications.
100% domain-agnostic and config-driven architecture.

Architecture:
- Reads raw JSON data from any domain
- Applies mapping rules from YAML config
- Generates NGSI-LD compliant entities
- Validates output against NGSI-LD schema
...
class NGSILDTransformerAgent:
    ...
    100% config-driven: All mappings in YAML configuration
