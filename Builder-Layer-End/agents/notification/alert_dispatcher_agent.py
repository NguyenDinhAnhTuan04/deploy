...
Domain-agnostic multi-channel notification system for NGSI-LD subscription webhooks.
Receives webhook notifications from Stellio and dispatches alerts via multiple channels.

Features:
- HTTP webhook server for Stellio notifications
- Multi-channel delivery: WebSocket, FCM, Email, SMS, Webhook
