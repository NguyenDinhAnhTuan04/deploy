...
Domain-agnostic NGSI-LD subscription manager for Stellio Context Broker.
Manages subscription lifecycle: create, read, update, delete, monitor, auto-renew.

Features:
- CRUD operations for NGSI-LD subscriptions
- Health monitoring with auto-renewal
- Config-driven subscription definitions
