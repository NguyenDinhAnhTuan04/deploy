...
Domain-agnostic incident report generation system for NGSI-LD entities.
Generates multi-format reports (PDF, JSON, HTML) with contextual data from Neo4j.

Features:
- Subscribe to incident entities (RoadAccident, TrafficIncident, etc.)
- Query Neo4j for contextual data
- Generate comprehensive reports with visualizations
- Multi-format output (PDF, JSON, HTML)
- Email notifications to stakeholders
- API endpoints for report retrieval
- Storage in filesystem/S3
...
class ReportDataCollector:
    ...
    def __init__(self, config: IncidentReportConfig):
        ...
        self.stellio_base_url = self.stellio_config.get(
