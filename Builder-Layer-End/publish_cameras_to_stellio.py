#!/usr/bin/env python3
"""
Publish all 42 camera entities from cameras_updated.json to Stellio Context Broker via REST API.
Uses verified working configuration: application/ld+json with @context in body.
Note: Must use cameras_updated.json (refreshed by image_refresh_agent) to get current timestamps.
"""
