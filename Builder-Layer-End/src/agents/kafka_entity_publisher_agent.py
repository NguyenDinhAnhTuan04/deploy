...
Publishes NGSI-LD entities directly to Kafka for Stellio consumption.
Bypasses API Gateway by publishing to the same Kafka topic that search-service consumes.
"""
