...
def sample_config(tmp_path):
    ...
    config = {
        'incident_report_generator': {
            ...
            'report_formats': [
                {'type': 'json', 'enabled': True, 'fields': ['report_id'], 'pretty_print': True},
                {'type': 'html', 'enabled': True, 'template': 'templates/incident_web.html'},
                {'type': 'pdf', 'enabled': False, 'template': 'templates/incident_report.html', 'engine': 'weasyprint'}
            ],
            'storage': {
                'filesystem': {
                    'enabled': True,
