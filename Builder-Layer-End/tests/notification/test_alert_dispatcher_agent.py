...
class TestRateLimiter:
    ...
    def test_rate_limiter_sliding_window(self, sample_config):
        ...
        limiter.hourly_counts["user1"] = [datetime.utcnow() - timedelta(hours=2)]
...
class TestFCMChannel:
    ...
    def test_fcm_no_token(self, sample_config):
        ...
        message = {"title": "Test Alert", "body": "Test body"}
...
class TestEmailChannel:
    ...
    def test_email_no_address(self, sample_config):
        ...
        message = {"email_subject": "Test Subject", "email_body": "Test Body"}
...
class TestSMSChannel:
    ...
    def test_sms_deliver_success(self, mock_post, sample_config):
        ...
        message = {"phone": "+1234567890", "sms_body": "Test SMS message"}
...
class TestAlertDispatcher:
    ...
    def test_extract_variables(self, config_file):
        ...
        notification = {
            ...
            "data": [{"speed": {"value": 45}, "camera_name": {"value": "Camera 123"}}],
        }
...
class TestEdgeCases:
    ...
    def test_network_timeout(self, mock_post, sample_config):
        ...
        message = {"fcm_token": "test_token", "title": "Test", "body": "Test"}
    ...
    def test_empty_notification_data(self, config_file):
        ...
        notification = {"id": "test_id", "type": "test_type"}
