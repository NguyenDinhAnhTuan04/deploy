...
class TestIntegration:
    ...
    def test_full_transformation_workflow(self, mock_config_file, mock_source_data, tmp_path):
...
class TestValidation:
    ...
    def test_ngsi_ld_structure_compliance(self, mock_config_file, mock_source_data, tmp_path):
