...
def valid_camera_entity():
    ...
    return {
        ...
        "location": {
            "type": "GeoProperty",
            "value": {"type": "Point", "coordinates": [106.677234, 10.782345]},
        },
        "status": {
            "type": "Property",
            "value": "online",
...
def invalid_camera_entity():
    ...
    return {
        ...
        "averageSpeed": {"type": "Property", "value": -10.0},  # Negative speed
        "imageSnapshot": {"type": "Property", "value": "not_a_url"},  # Invalid URL
    }
...
class TestSchemaValidator:
    ...
    def test_validate_property_structure(self, schema_validator):
        ...
        entity = {
            ...
            "type": "Camera",
            "@context": "https://uri.etsi.org/ngsi-ld/v1/ngsi-ld-core-context.jsonld",
            "status": {"value": "online"},  # Missing 'type' field
        }
    ...
    def test_validate_with_strict_mode_disabled(
        self, data_quality_config, valid_camera_entity
    ):
...
class TestBusinessRulesEngine:
    ...
    def test_evaluate_valid_coordinates(
        self, business_rules_engine, valid_camera_entity
    ):
    ...
    def test_evaluate_invalid_coordinates(self, business_rules_engine):
        ...
        entity = {
            ...
            "location": {
                "type": "GeoProperty",
                "value": {"type": "Point", "coordinates": [200.0, 100.0]},  # Invalid
            },
        }
    ...
    def test_evaluate_speed_validation(self, business_rules_engine):
        ...
        entity = {
            ...
            "type": "Camera",
            "@context": "https://uri.etsi.org/ngsi-ld/v1/ngsi-ld-core-context.jsonld",
            "averageSpeed": {"type": "Property", "value": 45.5},
        }
    ...
    def test_evaluate_negative_speed(self, business_rules_engine):
        ...
        entity = {
            ...
            "type": "Camera",
            "@context": "https://uri.etsi.org/ngsi-ld/v1/ngsi-ld-core-context.jsonld",
            "averageSpeed": {"type": "Property", "value": -10.0},
        }
    ...
    def test_evaluate_url_accessibility(self, mock_head, business_rules_engine):
        ...
        url_results = [
            r
            for r in results
            if "url" in r["rule"].lower() or "image" in r["rule"].lower()
        ]
    ...
    def test_extract_field_value_nested(self, business_rules_engine):
        ...
        entity = {"location": {"value": {"coordinates": [106.5, 10.5]}}}
    ...
    def test_expression_evaluation_comparison(self, business_rules_engine):
        ...
        # Test >= operator
        result = business_rules_engine._evaluate_expression("speed >= 0.0", 45.5, {})
        assert result is True

        # Test <= operator
        result = business_rules_engine._evaluate_expression("speed <= 120.0", 45.5, {})
        assert result is True

        # Test AND operator
        result = business_rules_engine._evaluate_expression(
            "speed >= 0.0 AND speed <= 120.0", 45.5, {}
        )
        assert result is True
    ...
    def test_expression_evaluation_in_operator(self, business_rules_engine):
        ...
        result = business_rules_engine._evaluate_expression(
            "200 IN [200, 301, 302]", 200, {}
        )
        assert result is True

        result = business_rules_engine._evaluate_expression(
            "404 IN [200, 301, 302]", 404, {}
        )
    ...
    def test_expression_evaluation_matches_operator(self, business_rules_engine):
        ...
        # Test regex matching
        result = business_rules_engine._evaluate_expression(
            "MATCHES(url, '^https?://')", "https://example.com", {}
        )
        assert result is True

        result = business_rules_engine._evaluate_expression(
            "MATCHES(url, '^https?://')", "not_a_url", {}
        )
        assert result is False
...
class TestQualityScorer:
    ...
    def test_calculate_score_schema_invalid(self, quality_scorer):
        ...
        rule_results = [{"passed": True, "weight": 1.0}]
...
class TestDataCleaner:
    ...
    def test_clean_trim_whitespace(self, data_cleaner):
        ...
        entity = {
            "id": "urn:ngsi-ld:Camera:TTH406",
            "type": "  Camera  ",
            "description": {"type": "Property", "value": "  Test description  "},
        }
    ...
    def test_clean_normalize_case(self, data_cleaner):
        ...
        entity = {"id": "urn:ngsi-ld:Camera:TTH406", "type": "camera"}
    ...
    def test_clean_numeric_precision(self, data_cleaner):
        ...
        entity = {
            ...
            "location": {
                "type": "GeoProperty",
                "value": {"coordinates": [106.12345678, 10.98765432]},
            },
        }
...
class TestDataQualityValidatorAgent:
    ...
    def test_validation_with_different_entity_types(self, validator_agent):
        ...
        entity = {
            ...
            "intensity": {"type": "Property", "value": 150},
        }
...
class TestEdgeCases:
    ...
    def test_validate_malformed_coordinates(self, validator_agent):
        ...
        entity = {
            ...
            "location": {
                "type": "GeoProperty",
                "value": {"coordinates": [106.5]},  # Missing latitude
            },
        }
...
class TestPerformance:
    ...
    def test_validate_722_entities_under_10_seconds(
        self, validator_agent, valid_camera_entity
    ):
        ...
        assert (
            elapsed_time < 10.0
        ), f"Validation took {elapsed_time:.2f}s, expected < 10s"
    ...
    def test_caching_improves_performance(self, business_rules_engine):
        ...
        assert (
            call_count_2 == 0
        ), "Second check should use cache, not call requests.head"
