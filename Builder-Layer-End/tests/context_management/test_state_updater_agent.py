...
def test_update_event_auto_event_id():
    ...
    data = {"entity_id": "urn:ngsi-ld:Camera:TTH406", "updates": {"test": "value"}}
...
def test_validate_update_invalid_type(temp_config):
    ...
    data = {
        "entity_id": "urn:ngsi-ld:Camera:TTH406",
        "updates": {
            "congested": {"type": "Property", "value": "yes"}  # Should be boolean
        },
    }
...
def test_validate_update_out_of_range(temp_config):
    ...
    data = {
        "entity_id": "urn:ngsi-ld:Camera:TTH406",
        "updates": {
            "intensity": {"type": "Property", "value": 1.5}  # Above max of 1.0
        },
    }
...
def test_patch_entity_success(
    mock_patch, temp_config, sample_update_event, mock_http_response
):
...
def test_validate_update_below_minimum(temp_config):
    ...
    data = {
        "entity_id": "urn:ngsi-ld:Camera:TTH406",
        "updates": {
            "intensity": {"type": "Property", "value": -0.5}  # Below min of 0.0
        },
    }
...
def test_update_event_with_metadata():
    ...
    data = {
        "entity_id": "urn:ngsi-ld:Camera:TTH406",
        "updates": {"test": "value"},
        "metadata": {"source": "sensor-123", "priority": "high"},
    }
