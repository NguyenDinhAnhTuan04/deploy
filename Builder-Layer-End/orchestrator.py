...
100% CONFIG-DRIVEN - All workflow, phases, and agents defined in workflow.yaml

This orchestrator manages the execution of multiple agents across different phases:
